...
namespace Dekoundgarten\Widgets\Header;
...
{
    /** @inheritDoc */
    protected $template = 'Dekoundgarten::Widgets.Header.NavigationWidget';
    ...
    {
        return WidgetDataFactory::make('Dekoundgarten::NavigationWidget')
